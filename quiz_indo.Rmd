...
1. Data time series memiliki beberapa karakteristik. Manakah pernyataan di bawah ini yang **BENAR** terkait time series?
  - [ ] *Additive time series* disebut additive karena amplitudo/besaran aktivitas *seasonal*-nya meningkat selama periode observasi.
  - [ ] *Multiplicative time series* disebut multiplicative karena seiring dengan meningkatnya tren, amplitudo/besaran aktivitas *seasonal*-nya juga meningkat.
...
3. Berdasarkan grafik dekomposisi di atas, apakah tepat apabila kita menggunakan model *Holt-Winters*? Mengapa?
  - [ ] Ya, karena grafik tersebut mengandung pola tren dan *seasonal*
...
5. Berdasarkan penjelasan di atas, manakah dari pernyataan dibawah ini yang **BENAR** mengenai ARIMA(p,d,q)?
  ...
  - [ ] p adalah jumlah *order* yang digunakan untuk menentukan proses pembuatan model *Autoregressive*
...
6. Berdasarkan hasil di atas, manakah dari pernyataan berikut yang **BENAR**?
  ...
  - [ ] Perbedaan nilai *mean absolute percentage error* antara model ARIMA dan *Holt-Winters* adalah 0.54%
